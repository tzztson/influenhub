const Footer = () => {
    return (
        <div className={`relative bg-white`}>
            <div className="flex justify-between gap-12 py-12 max-xl:px-8 max-lg:flex-col">
                <div className="flex gap-4  flex-[1_1_30%]  justify-center max-lg:justify-start">
                ...
                <div className="flex max-sm:flex-col gap-24 max-xl:gap-20 max-[1080px]:gap-12 flex-[1_1_70%] justify-center max-lg:justify-start">
                    <div className='flex gap-24 max-lg:gap-12'>
            ...
            <div className='bg-[#5a4e97] py-6 text-white px-12 text-xl flex justify-between max-[680px]:flex-col gap-8'>
